...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV1P0_3(W(1,4),W(1,3),GC_1,ZERO, FK_ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1_3_3(W(1,4),W(1,3),GC_195,-GC_135,MDL_MZ, FK_MDL_WZ,W(1
     $ ,11))
C     Amplitude(s) for diagram number 3
      CALL FFV1_3_0(W(1,9),W(1,6),W(1,11),GC_197,-GC_135,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV1_3_0(W(1,5),W(1,10),W(1,11),GC_197,-GC_135,AMP(4))
      CALL FFV1_3_3(W(1,1),W(1,2),GC_196,GC_135,MDL_MZ, FK_MDL_WZ,W(1
     $ ,10))
      CALL FFV1_3_2(W(1,5),W(1,10),GC_197,-GC_135,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,9),W(1,6),W(1,8),-GC_3,AMP(5))
      CALL FFV1_3_1(W(1,6),W(1,10),GC_197,-GC_135,ZERO, FK_ZERO,W(1,12)
     $ )
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFS1_3(W(1,4),W(1,3),GC_503,MDL_MH, FK_MDL_WH,W(1,12))
      CALL FFV1P0_3(W(1,5),W(1,6),-GC_3,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 9
      CALL VVS4_0(W(1,7),W(1,9),W(1,12),GC_223,AMP(9))
      CALL FFV1_3_3(W(1,5),W(1,6),GC_197,-GC_135,MDL_MZ, FK_MDL_WZ,W(1
     $ ,13))
C     Amplitude(s) for diagram number 10
      CALL VVS4_0(W(1,7),W(1,13),W(1,12),GC_227,AMP(10))
      CALL FFS2_3(W(1,4),W(1,3),GC_451,MDL_MH, FK_MDL_WH,W(1,6))
C     Amplitude(s) for diagram number 11
      CALL VVS4_0(W(1,7),W(1,9),W(1,6),GC_223,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL VVS4_0(W(1,7),W(1,13),W(1,6),GC_227,AMP(12))
      CALL FFS2_3(W(1,4),W(1,3),GC_504,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 13
      CALL VVS4_0(W(1,7),W(1,9),W(1,5),GC_223,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL VVS4_0(W(1,7),W(1,13),W(1,5),GC_227,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL VVS4_0(W(1,9),W(1,10),W(1,12),GC_227,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL VVS3_0(W(1,10),W(1,13),W(1,12),GC_284,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL VVS4_0(W(1,9),W(1,10),W(1,6),GC_227,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL VVS3_0(W(1,10),W(1,13),W(1,6),GC_284,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL VVS4_0(W(1,9),W(1,10),W(1,5),GC_227,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL VVS3_0(W(1,10),W(1,13),W(1,5),GC_284,AMP(20))
      CALL FFV1_1(W(1,3),W(1,7),GC_1,MDL_MB, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,4),W(1,5),W(1,9),GC_1,AMP(21))
      CALL FFV1_2(W(1,4),W(1,7),GC_1,MDL_MB, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,6),W(1,3),W(1,9),GC_1,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV1_3_0(W(1,4),W(1,5),W(1,13),GC_195,-GC_135,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_3_0(W(1,6),W(1,3),W(1,13),GC_195,-GC_135,AMP(24))
      CALL FFV1_3_1(W(1,3),W(1,10),GC_195,-GC_135,MDL_MB, FK_ZERO,W(1
     $ ,6))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,4),W(1,6),W(1,9),GC_1,AMP(25))
      CALL FFV1_3_2(W(1,4),W(1,10),GC_195,-GC_135,MDL_MB, FK_ZERO,W(1
     $ ,5))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,5),W(1,3),W(1,9),GC_1,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV1_3_0(W(1,4),W(1,6),W(1,13),GC_195,-GC_135,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV1_3_0(W(1,5),W(1,3),W(1,13),GC_195,-GC_135,AMP(28))
      CALL FFV1_2(W(1,1),W(1,8),GC_2,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,5),W(1,2),W(1,9),GC_2,AMP(29))
      CALL FFV1_2(W(1,1),W(1,9),GC_2,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,3),W(1,2),W(1,8),GC_2,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_3_0(W(1,5),W(1,2),W(1,13),GC_196,GC_135,AMP(31))
      CALL FFV1_3_2(W(1,1),W(1,13),GC_196,GC_135,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,5),W(1,2),W(1,8),GC_2,AMP(32))
      CALL FFV1_3_2(W(1,1),W(1,11),GC_196,GC_135,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,8),W(1,2),W(1,9),GC_2,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFV1_3_0(W(1,3),W(1,2),W(1,11),GC_196,GC_135,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV1_3_0(W(1,8),W(1,2),W(1,13),GC_196,GC_135,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL FFV1_3_0(W(1,5),W(1,2),W(1,11),GC_196,GC_135,AMP(36))
...
C     JAMPs contributing to orders NP=0
     ...
     $ *AMP(24)+(-1.000000000000000D+00)*AMP(25)+(-1.000000000000000D
     $ +00)*AMP(26)+(-1.000000000000000D+00)*AMP(27)+(
     $ -1.000000000000000D+00)*AMP(28)+(-1.000000000000000D+00)*AMP(29)
     $ +(-1.000000000000000D+00)*AMP(30)+(-1.000000000000000D+00)
     $ *AMP(31)+(-1.000000000000000D+00)*AMP(32)+(-1.000000000000000D
     $ +00)*AMP(33)+(-1.000000000000000D+00)*AMP(34)+(
     $ -1.000000000000000D+00)*AMP(35)+(-1.000000000000000D+00)*AMP(36)
C     JAMPs contributing to orders NP=1
      JAMP(1,2) = (-1.000000000000000D+00)*AMP(9)+(-1.000000000000000D
     $ +00)*AMP(10)+(-1.000000000000000D+00)*AMP(13)+(
     $ -1.000000000000000D+00)*AMP(14)+(-1.000000000000000D+00)*AMP(15)
     $ +(-1.000000000000000D+00)*AMP(16)+(-1.000000000000000D+00)
     $ *AMP(19)+(-1.000000000000000D+00)*AMP(20)
      ...
      IF(SDE_STRAT.EQ.1)THEN
        ...
        AMP2(9)=AMP2(9)+(AMP(9)+AMP(11)+AMP(13))*DCONJG(AMP(9)+AMP(11)
     $   +AMP(13))
        AMP2(10)=AMP2(10)+(AMP(10)+AMP(12)+AMP(14))*DCONJG(AMP(10)
     $   +AMP(12)+AMP(14))
        AMP2(15)=AMP2(15)+(AMP(15)+AMP(17)+AMP(19))*DCONJG(AMP(15)
     $   +AMP(17)+AMP(19))
        AMP2(16)=AMP2(16)+(AMP(16)+AMP(18)+AMP(20))*DCONJG(AMP(16)
     $   +AMP(18)+AMP(20))
