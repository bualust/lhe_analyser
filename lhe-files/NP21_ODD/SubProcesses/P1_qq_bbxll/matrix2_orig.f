...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV1_3_3(W(1,1),W(1,2),GC_195,-GC_135,MDL_MZ, FK_MDL_WZ,W(1
     $ ,10))
...
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,5),W(1,2),W(1,9),GC_1,AMP(29))
      CALL FFV1_2(W(1,1),W(1,9),GC_1,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,3),W(1,2),W(1,8),GC_1,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_3_0(W(1,5),W(1,2),W(1,13),GC_195,-GC_135,AMP(31))
      CALL FFV1_3_2(W(1,1),W(1,13),GC_195,-GC_135,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,5),W(1,2),W(1,8),GC_1,AMP(32))
      CALL FFV1_3_2(W(1,1),W(1,11),GC_195,-GC_135,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,8),W(1,2),W(1,9),GC_1,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFV1_3_0(W(1,3),W(1,2),W(1,11),GC_195,-GC_135,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV1_3_0(W(1,8),W(1,2),W(1,13),GC_195,-GC_135,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL FFV1_3_0(W(1,5),W(1,2),W(1,11),GC_195,-GC_135,AMP(36))
