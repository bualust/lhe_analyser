...
C     
C     Process: u u~ > b b~ e+ e- QCD=0 NP^2==2 @1
C     Process: c c~ > b b~ e+ e- QCD=0 NP^2==2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL FFV1P0_3(W(1,1),W(1,4),GC_2,ZERO,FK_ZERO,W(1,13))  !  count 16
      CALL FFV1P0_3(W(1,2),W(1,3),GC_2,ZERO,FK_ZERO,W(1,14))  !  count 16
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_3_3(W(1,1),W(1,4),GC_196,GC_135,MDL_MZ,FK_MDL_WZ,W(1,27)
     $)  !  count 16
      CALL FFV1_3_3(W(1,2),W(1,3),GC_196,GC_135,MDL_MZ,FK_MDL_WZ,W(1,28)
     $)  !  count 16
