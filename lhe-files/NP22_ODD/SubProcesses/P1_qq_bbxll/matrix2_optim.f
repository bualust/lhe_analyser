...
C     
C     Process: d d~ > b b~ e+ e- QCD=0 NP^2==2 @1
C     Process: s s~ > b b~ e+ e- QCD=0 NP^2==2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL IXXXXX(P(0,5),ZERO,-1,-1*IC(5),W(1,10))  !  count 2
      CALL OXXXXX(P(0,6),ZERO,+1,+1*IC(6),W(1,11))  !  count 2
      CALL OXXXXX(P(0,6),ZERO,-1,+1*IC(6),W(1,12))  !  count 2
      CALL FFV1P0_3(W(1,1),W(1,4),GC_1,ZERO,FK_ZERO,W(1,13))  !  count 16
      CALL FFV1P0_3(W(1,2),W(1,3),GC_1,ZERO,FK_ZERO,W(1,14))  !  count 16
      CALL FFS1_3(W(1,7),W(1,5),GC_503,MDL_MH,FK_MDL_WH,W(1,15))  !  count 16
      CALL FFS1_3(W(1,7),W(1,6),GC_503,MDL_MH,FK_MDL_WH,W(1,16))  !  count 16
      CALL FFS1_3(W(1,8),W(1,5),GC_503,MDL_MH,FK_MDL_WH,W(1,17))  !  count 16
      CALL FFS1_3(W(1,8),W(1,6),GC_503,MDL_MH,FK_MDL_WH,W(1,18))  !  count 16
      CALL FFV1P0_3(W(1,9),W(1,12),-GC_3,ZERO,FK_ZERO,W(1,19))  !  count 16
      CALL FFV1P0_3(W(1,10),W(1,11),-GC_3,ZERO,FK_ZERO,W(1,20))  !  count 16
      CALL VVS4P1N_3(W(1,13), W(1,19), GC_223, TMP(1))
      call CombineAmpS(4, 
     &(/5,1,7,3/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,1))
      CALL VVS4P1N_3(W(1,13), W(1,20), GC_223, TMP(1))
      call CombineAmpS(4, 
     &(/6,2,8,4/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,1))
      CALL VVS4P1N_3(W(1,14), W(1,19), GC_223, TMP(1))
      call CombineAmpS(4, 
     &(/13,9,15,11/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,1))
      CALL VVS4P1N_3(W(1,14), W(1,20), GC_223, TMP(1))
      call CombineAmpS(4, 
     &(/14,10,16,12/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1_3_3(W(1,9),W(1,12),GC_197,-GC_135,MDL_MZ,FK_MDL_WZ,W(1,2
     $1))  !  count 16
      CALL FFV1_3_3(W(1,10),W(1,11),GC_197,-GC_135,MDL_MZ,FK_MDL_WZ,W(1,
     $22))  !  count 16
      CALL VVS4P1N_3(W(1,13), W(1,21), GC_227, TMP(1))
      call CombineAmpS(4, 
     &(/5,1,7,3/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,2))
      CALL VVS4P1N_3(W(1,13), W(1,22), GC_227, TMP(1))
      call CombineAmpS(4, 
     &(/6,2,8,4/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,2))
      CALL VVS4P1N_3(W(1,14), W(1,21), GC_227, TMP(1))
      call CombineAmpS(4, 
     &(/13,9,15,11/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,2))
      CALL VVS4P1N_3(W(1,14), W(1,22), GC_227, TMP(1))
      call CombineAmpS(4, 
     &(/14,10,16,12/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_3_3(W(1,1),W(1,4),GC_195,-GC_135,MDL_MZ,FK_MDL_WZ,W(1,27
     $))  !  count 16
      CALL FFV1_3_3(W(1,2),W(1,3),GC_195,-GC_135,MDL_MZ,FK_MDL_WZ,W(1,28
     $))  !  count 16
      CALL VVS4P1N_3(W(1,19), W(1,27), GC_227, TMP(1))
      call CombineAmpS(4, 
     &(/5,1,7,3/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,5))
      CALL VVS4P1N_3(W(1,19), W(1,28), GC_227, TMP(1))
      call CombineAmpS(4, 
     &(/13,9,15,11/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,5))
      CALL VVS4P1N_3(W(1,20), W(1,27), GC_227, TMP(1))
      call CombineAmpS(4, 
     &(/6,2,8,4/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,5))
      CALL VVS4P1N_3(W(1,20), W(1,28), GC_227, TMP(1))
      call CombineAmpS(4, 
     &(/14,10,16,12/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,5))  !  count 1
      CALL VVS3P1N_3(W(1,27), W(1,21), GC_284, TMP(1))
      call CombineAmpS(4, 
     &(/5,1,7,3/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,6))
      CALL VVS3P1N_3(W(1,27), W(1,22), GC_284, TMP(1))
      call CombineAmpS(4, 
     &(/6,2,8,4/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,6))
      CALL VVS3P1N_3(W(1,28), W(1,21), GC_284, TMP(1))
      call CombineAmpS(4, 
     &(/13,9,15,11/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,6))
      CALL VVS3P1N_3(W(1,28), W(1,22), GC_284, TMP(1))
      call CombineAmpS(4, 
     &(/14,10,16,12/), 
     & (/15,16,17,18/), 
...
C       JAMPs contributing to orders NP=1
     ...
     $  D+00)*AMP( K,8)
        ...
        IF(SDE_STRAT.EQ.1)THEN
          AMP2(1)=AMP2(1)+(AMP( K,1)+AMP( K,3))*DCONJG(AMP( K,1)+AMP( K,
     $    3))
          AMP2(2)=AMP2(2)+(AMP( K,2)+AMP( K,4))*DCONJG(AMP( K,2)+AMP( K,
     $    4))
          AMP2(5)=AMP2(5)+(AMP( K,5)+AMP( K,7))*DCONJG(AMP( K,5)+AMP( K,
     $    7))
          AMP2(6)=AMP2(6)+(AMP( K,6)+AMP( K,8))*DCONJG(AMP( K,6)+AMP( K,
     $    8))
        ENDIF
