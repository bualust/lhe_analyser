...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFS1_3(W(1,4),W(1,3),GC_503,MDL_MH, FK_MDL_WH,W(1,8))
      CALL FFV1P0_3(W(1,5),W(1,6),-GC_3,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL VVS4_0(W(1,7),W(1,9),W(1,8),GC_223,AMP(1))
      CALL FFV1_3_3(W(1,5),W(1,6),GC_197,-GC_135,MDL_MZ, FK_MDL_WZ,W(1
     $ ,10))
C     Amplitude(s) for diagram number 2
      CALL VVS4_0(W(1,7),W(1,10),W(1,8),GC_227,AMP(2))
      CALL FFS2_3(W(1,4),W(1,3),GC_504,MDL_MH, FK_MDL_WH,W(1,6))
C     Amplitude(s) for diagram number 3
      CALL VVS4_0(W(1,7),W(1,9),W(1,6),GC_223,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL VVS4_0(W(1,7),W(1,10),W(1,6),GC_227,AMP(4))
      CALL FFV1_3_3(W(1,1),W(1,2),GC_195,-GC_135,MDL_MZ, FK_MDL_WZ,W(1
     $ ,7))
C     Amplitude(s) for diagram number 5
      CALL VVS4_0(W(1,9),W(1,7),W(1,8),GC_227,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VVS3_0(W(1,7),W(1,10),W(1,8),GC_284,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL VVS4_0(W(1,9),W(1,7),W(1,6),GC_227,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL VVS3_0(W(1,7),W(1,10),W(1,6),GC_284,AMP(8))
...
C     JAMPs contributing to orders NP=1
     ...
     $ +(-1.000000000000000D+00)*AMP(8)
      ...
      IF(SDE_STRAT.EQ.1)THEN
        ...
        AMP2(2)=AMP2(2)+(AMP(2)+AMP(4))*DCONJG(AMP(2)+AMP(4))
        AMP2(5)=AMP2(5)+(AMP(5)+AMP(7))*DCONJG(AMP(5)+AMP(7))
